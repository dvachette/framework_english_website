    ...
    return (
      <div className="app">
        ...
        <aside className="sidebar">
          ...
          <Button id="bt-2" label="Click Me" onclick={() => scrollToElement("social")} iconPath="/src/assets/home.png" />
          <Button id="bt-3" label="Click Me" onclick={() => scrollToElement("support")} iconPath="/src/assets/home.png" />
        </aside>
      </div>
  );
}
